from app.application.notifications.handlers.utils.render_activation_email import (
...
class SendUserActivationHandler:
    def __init__(self, email_service: EmailService, token_service: VersionedTokenService):
    ...
    async def handle(self, event: ActivationEmailRequested) -> None:
        ...
        await self.email_service.send_email(to=event.email, subject="Ative sua conta", html_content=html)
