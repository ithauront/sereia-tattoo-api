...
where credits should not be generated from breaking the appointment
completion flow.

However, infrastructure or persistence failures during credit creation
must rollback the entire transaction, since client credits are part
of the financial consistency of the system. Hence the UoW in context.
"""
