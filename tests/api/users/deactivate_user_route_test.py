...
def test_deactivate_user(repo, make_user, make_token):
...
def test_deactivate_nonexistent_user(repo, make_user, make_token):
    admin = make_user(is_admin=True)
    user = make_user(is_active=True)
...
def test_route_cannot_deactivate_yourself(repo, make_user, make_token):
...
def test_deactivate_user_inactive(repo, make_user, make_token):
    admin = make_user(is_admin=True)
...
def test_not_admin_deactivate_user(repo, make_user, make_token):
...
def test_inactive_admin_deactivate_user(repo, make_user, make_token):
...
def test_nonexistent_user_deactivate_user(repo, make_user, make_token):
    admin = make_user(is_admin=True)
    user = make_user(is_active=True)
...
def wrong_token_type_deactivate_user(repo, make_user, make_token):
    admin = make_user(is_admin=True)
    user = make_user(is_active=True)
