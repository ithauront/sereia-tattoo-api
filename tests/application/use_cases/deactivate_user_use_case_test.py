...
def test_cannot_deactivate_yourself(write_uow, make_user):
...
def test_last_active_admin_cannot_be_deactivated(write_uow, make_user):
...
def test_user_not_found_to_deactivate(write_uow, make_user):
...
def test_user_already_inactive(write_uow, make_user):
    admin = make_user(is_active=True, is_admin=True)
